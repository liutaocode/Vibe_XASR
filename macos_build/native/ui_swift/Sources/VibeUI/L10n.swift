...
public final class L10n: ObservableObject {
    ...
    static let en: [String: String] = [
        ...
        "about.feedback.guide": "Submit feedback as a Pull Request on GitHub. Please include:\n①  What the problem is\n②  Steps to reproduce it\n③  The result you expected\nFor a new feature, just describe your idea directly.",
        "about.feedback.go": "Open GitHub Pull Requests",
    ...
    static let zh: [String: String] = [
        ...
        "about.feedback": "功能反馈",
        "about.feedback.title": "提交反馈",
        "about.feedback.guide": "功能反馈提交到 GitHub 的 Pull Requests。请说明：\n①  问题描述\n②  复现步骤\n③  期望的结果\n如果是新功能，可直接填入你的想法。",
        "about.feedback.go": "前往提交 (GitHub PR)",
        "about.credits": "同时基于",
    ...
    static let ja: [String: String] = [
        ...
        "about.feedback.title": "フィードバックを送る",
        "about.feedback.guide": "フィードバックは GitHub の Pull Requests に送ってください。次の点を記載してください：\n①  問題の内容\n②  再現手順\n③  期待する結果\n新機能の場合は、アイデアをそのまま記入してください。",
        "about.feedback.go": "GitHub で提出する",
    ...
    static let ko: [String: String] = [
        ...
        "about.feedback": "피드백",
        "about.feedback.title": "피드백 보내기",
        "about.feedback.guide": "피드백은 GitHub의 Pull Requests로 제출해 주세요. 다음을 적어 주세요:\n①  문제 설명\n②  재현 방법\n③  기대한 결과\n새 기능이라면 아이디어를 바로 적어 주세요.",
        "about.feedback.go": "GitHub에서 제출하기",
